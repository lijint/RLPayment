...
namespace YAPayment.Package.EMV.PowerEMV
{
    class CCarDownAID : CarPay
    {
        /// <summary>
                ...
                case 0:
                    {
                        ...
                        SendPackage.SetArrayData(5, Utility.str2Bcd("7200100026"));//特色交易域 10bcd
                ...
                case 1:
                    {
                        ...
                        SendPackage.SetArrayData(5, Utility.str2Bcd("7200100025"));//特色交易域 10bcd
