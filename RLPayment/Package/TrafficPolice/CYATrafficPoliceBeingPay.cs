...
{
    class CYATrafficPoliceBeingPay : YAPaymentPay
    {
        ...
        {
            string temp = "U0V2571165000000" + "".PadLeft(50, ' ') + "000000";
            ...
            handler.AddTag("2F1A", "0103");//渠道标识 银商自助终端
            handler.AddTag("BF05", PayEntity.TPQueryTraceNo);
        ...
        protected override void OnSucc()
        {
            ...
            PayEntity.TPPayFlowNo = handler.GetStringValue("BF05");
        }
    }
}
